    ...
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            recipe.AddStep(new Step(GetProduct("Leche"), 200, GetEquipment("Hervidor"), 60));
             ...
             /*IPrinter = new AllInOnePrinter();
            printer.PrintRecipe(recipe, Destination.Console);
            printer.PrintRecipe(recipe, Destination.File);*/

            // reemplace allinoneprinter por consoleprinter y fileprinter
            IPrinter printer = new ConsolePrinter();
            printer.PrintRecipe(recipe);
            //ahora se puede imprimir por consola o por archivo de texto
            //defino una nueva variable printer2 que imprime por archivo de texto
